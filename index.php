...
// Validate the user:
if (isset($_SESSION['user_id'], $_SESSION['agent']) && ($_SESSION['agent'] == md5($_SERVER['HTTP_USER_AGENT']))) {  // If the user has logged in, show a welcome message.
    ...
    echo '<p>Silakan <a class="navlink" href="login.php">Login</a> untuk mulai menggunakan website ini.</p>'; 
