...
INSERT INTO `tb_akun` VALUES (1,'john@beatles.com','2a50435b0f512f60988db719106a258fb7e338ff','administrator',1),(2,'paul@beatles.com','6ae16792c502a5b47da180ce8456e5ae7d65e262','manager',2),(3,'george@beatles.com','1af17e73721dbe0c40011b82ed4bb1a7dbe3ce29','gudang',3),(4,'ringo@beatles.com','520f73691bcf89d508d923a2dbc8e6fa58efb522','kasir',4),(5,'admin1@email.com','7110eda4d09e062aa5e4a390b0a572ac0d2c0220','administrator',5),(6,'kasir2@email.com','08dfc5f04f9704943a423ea5732b98d3567cbd49','kasir',7),(7,'gudang1@email.com','69c790d6e836dbbe1d6417e7d2300f6570e81125','gudang',9),(8,'manager1@email.com','a5c297c15e40ac3881db51277613aea3731b673a','manager',10),(9,'admin2@email.com','315f166c5aca63a157f7d41007675cb44a948b33','administrator',6),(10,'kasir3@email.com','dd4fab4a0925326b97aeb5435b0016b1f4ad9863','kasir',12),(11,'kasir4@email.com','5db85626fdf0bbfafe45e77eeba3efdd26c8985b','kasir',15),(12,'gudang2@email.com','c9708f9a1980cd4a606a39388cd5f7297034d2fb','gudang',13),(13,'manager2@email.com','d2c9a46b3870e03e3c45c6a6ba0d7a574f50c698','manager',14),(14,'admin3@email.com','33aab3c7f01620cade108f488cfd285c0e62c1ec','administrator',11),(15,'kasir1@email.com','874c0ac75f323057fe3b7fb3f5a8a41df2b94b1d','kasir',8);
/*!40000 ALTER TABLE `tb_akun` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tb_akun2`
--

DROP TABLE IF EXISTS `tb_akun2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_akun2` (
  `kode_akun` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(40) NOT NULL,
  `kata_sandi` varchar(40) NOT NULL,
  `akses` enum('administrator','gudang','kasir','manager') NOT NULL,
...
--
-- Dumping data for table `tb_akun2`
--

LOCK TABLES `tb_akun2` WRITE;
/*!40000 ALTER TABLE `tb_akun2` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_akun2` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_pegawai` VALUES (1,'John Lennon','L','123456789','New York','john@beatles.com'),(2,'Paul McCartney','L','123456788','California','paul@beatles.com'),(3,'George Harrison','L','123456787','Nevada','george@beatles.com'),(4,'Ringo Starr','L','123456786','Los Angeles','ringo@beatles.com'),(5,'admin1','L','12345','jl. abc','admin1@email.com'),(6,'admin2','P','12345','Jl. admin2','admin2@email.com'),(7,'kasir2','P','12345','Jl. Kasir No. 2','kasir2@email.com'),(8,'kasir1','L','123456789','New York','kasir1@email.com'),(9,'gudang1','L','123456788','California','gudang1@email.com'),(10,'manager1','L','123456787','Nevada','manager1@email.com'),(11,'admin3','L','123456786','Los Angeles','admin3@email.com'),(12,'kasir3','P','123456789','New York','kasir3@email.com'),(13,'gudang2','P','123456788','California','gudang2@email.com'),(14,'manager2','P','123456787','Nevada','manager2@email.com'),(15,'kasir4','P','123456786','Los Angeles','kasir4@email.com');
...
-- Dump completed on 2018-07-16 11:02:07
